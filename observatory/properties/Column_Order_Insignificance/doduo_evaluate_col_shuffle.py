"""
The purpose of this script is to evaluate the effect of column order insignificance on the column embeddings of a table by using the doduo model.
...
def process_table_wrapper(table_index, table, args, model_name, model, device):
    ...
    (
        ...
        table_avg_mcv,
    ) = analyze_embeddings(all_shuffled_embeddings, tables)
