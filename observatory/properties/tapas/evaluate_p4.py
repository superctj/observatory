...
def process_table_wrapper(truncated_tables, args, model_name, model, tokenizer, device, max_length, padding_token, key, changed_column_list):
    ...
    all_shuffled_embeddings = generate_p4_embeddings(tokenizer, model, device, max_length, padding_token, truncated_tables)
...
def process_and_save_embeddings(model_name, args, result_dict):
    ...
    for key, value in result_dict.items():
        ...
        process_table_wrapper(truncated_tables, args, model_name, model, tokenizer, device, max_length, padding_token,key,value[1])
