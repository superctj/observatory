"""
python create_row_shuffle_embeddings.py -r normal_TD  -s RI_bert_TD \
-m bert-base-uncased -n 1000
"""
...
from observatory.models.TaBERT.table_bert import Column, Table, TableBertModel
...
def generate_row_shuffle_embeddings(model, device, table, num_shuffles):
    ...
    for j in range(len(tables)):
        ...
        # Free up some memory by deleting column_encoding and info_dict
        del column_encoding
        del info_dict
