...
def process_table_wrapper(table_index, truncated_table, args, model_name, model, tokenizer, device, max_length, padding_token):
    save_directory_results  = os.path.join('/nfs/turbo/coe-jag/zjsun', 'col_insig', args.save_directory, model_name ,'results')
    save_directory_embeddings  = os.path.join('/nfs/turbo/coe-jag/zjsun','col_insig', args.save_directory, model_name ,'embeddings')
    ...
    all_shuffled_embeddings = generate_col_shuffle_embeddings(tokenizer, model, device, max_length, padding_token, truncated_table, args.num_shuffles)
