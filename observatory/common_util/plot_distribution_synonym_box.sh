...
python plot_distribution.py  --read_folders /nfs/turbo/coe-jag/zjsun/p4/p4_SD_synonym/bert-base-uncased/results \
...
--labels bert tapas roberta t5 tabert --save_folder ./p4_plot2 --picture_name synonym.png