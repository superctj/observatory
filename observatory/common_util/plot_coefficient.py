...
def calculate_spearman(file_path):
    ...
    multiset_jaccard_similarities = [
        result["multiset_jaccard_similarity"] for result in results
    ]
    ...
    coef_multiset_jaccard, p_multiset_jaccard = stats.spearmanr(
        cosine_similarities, multiset_jaccard_similarities
    )
    ...
    print(
        ...
        coef_containment,
        coef_jaccard,
        coef_multiset_jaccard,
    )
    print("p-values: ", p_containment, p_jaccard, p_multiset_jaccard)
    print("-----------------------------")

    return {
        "containment": (coef_containment, p_containment),
