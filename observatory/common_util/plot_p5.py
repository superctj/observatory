...
parser.add_argument(
    "--results_file", type=str, required=True, help="Path to the results.pt file"
)
parser.add_argument(
    "--save_dir", type=str, required=True, help="Directory to save the output picture"
)
parser.add_argument(
    "--pic_name", type=str, required=True, help="Name for the output picture"
)
