...
class TurlWikiTableDataset(Dataset):
    ...
    def _preprocess_data(self):
        ...
        for entity_cells, rows, headers, entity_columns in zip(
            list_entity_cells, list_rows, shuffled_headers, shuffled_entity_columns
        ):
        ...
        return (
            processed_data,
            [list(range(len(original_rows[0])))] + perms,
            keepeded_entity_columns,
        )
