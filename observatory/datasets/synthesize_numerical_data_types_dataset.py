...
NON_TEXT_TYPES = {"numberOfPages": 300, "isbn": 300, "image": 150, "url": 150, "ratingValue": 300, "price": 300, "startDate": 50, "endDate": 50, "validFrom": 50, "dateCreated": 50, "releaseDate": 50, "datePublished": 50, "telephone": 300, "postalCode": 300, "faxNumber": 300, "weight": 300}

TEXT_TYPES = {"inLanguage": 300, "priceCurrency": 300, "publisher": 300, "review": 300, "director": 100, "actor": 100, "byArtist": 100, "inAlbum": 300, "jobTitle": 300, "addressCountry": 150, "nationality": 150, "streetAddress": 300, "addressRegion": 300}

NON_TEXT_TYPE_MAPPING = {"numberOfPages": "numberOfPages", "isbn": "isbn", "image": "url", "url": "url", "ratingValue": "ratingValue", "price": "price", "startDate": "date", "endDate": "date", "validFrom": "date", "dateCreated": "date", "releaseDate": "date", "datePublished": "date", "telephone": "telephone", "postalCode": "postalCode", "faxNumber": "faxNumber", "weight": "weight"}

TEXT_TYPE_MAPPING = {"inLanguage": "language", "priceCurrency": "currency", "publisher": "organization", "review": "review", "director": "personName", "actor": "personName", "byArtist": "personName", "inAlbum": "musicAlbum", "jobTitle": "jobTitle", "addressCountry": "country", "nationality": "country", "streetAddress": "streetAddress", "addressRegion": "addressRegion"} # "author": "person", "director": "person", "actor": "person", "byArtist": "person"
...
def collect_text_type_data(annotation_dir, train_annotations):
    ...
    output_filepath = os.path.join(annotation_dir, f"text_types_{num_unique_labels}-classes_metadata.csv")
...
if __name__ == "__main__":
    root_dir = "/ssd/congtj/data/semtab2023/Round1-SOTAB-CPA-SCH" # Round1-SOTAB-CPA-SCH"
